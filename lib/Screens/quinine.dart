...
class QuinineScreen extends StatefulWidget {
  const QuinineScreen({super.key});

  @override
  _QuinineScreenState createState() => _QuinineScreenState();
}

class _QuinineScreenState extends State<QuinineScreen> {
  ...
  void _calculatePoids() async {
    ...
    setState(() {
      ...
      if (weight <= 0) {
        ...
        _errorMessage = '';
        _hasCalculated = true;
        dose = weight * 10; // Dose d'entretien
        dosecharge = weight * 20; // Dose de charge
      }
      _isLoading = false;
    });
  }
