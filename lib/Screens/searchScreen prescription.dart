...
class SearchPrescriptionScreen extends StatefulWidget {
  ...
  SearchPrescriptionScreen({super.key, required this.listes, required this.hintText});
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  focusedBorder: OutlineInputBorder( borderRadius: BorderRadius.circular(30.0),borderSide: const BorderSide(color: const Color(0xfffc6e6ff))),
