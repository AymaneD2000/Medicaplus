...
class SearchMedicamentClasseScreen extends StatefulWidget {
  ...
  SearchMedicamentClasseScreen({super.key, required this.listes, required this.hintText});

  @override
  State<SearchMedicamentClasseScreen> createState() => _SearchMedicamentClasseScreenState();
}

class _SearchMedicamentClasseScreenState extends State<SearchMedicamentClasseScreen> {
